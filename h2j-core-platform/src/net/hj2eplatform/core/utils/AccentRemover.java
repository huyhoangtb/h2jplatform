...
public class AccentRemover {
    ...
    private static char[] REPLACEMENTS = {'-', '\0', '\0', '\0', '\0', '\0',
        ...
        'U', 'u',};
    public static String DEFAULT_URL = "tour-travel-bookingtour-vn";

    public static String toUrlFriendly(String url) {
        url = DataValidator.deleteSpace(url);
        int maxLength = Math.min(url.length(), 236);
        ...
        return String.valueOf(buffer, 0, n).replace('/', '-');
    }
